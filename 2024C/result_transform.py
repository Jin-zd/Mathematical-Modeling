"""
result_transform.py 将计算数据进行整合，生成符合提交条件的数据
"""
...
def season_transform(result_matrix, season_num, data):
    ...
    for i in range(data.shape[0]):
        ...
        for j in range(2, data.shape[1]):
            crop = columns[j]
            if data.iloc[i, j] == 1:
                if result.loc[result['地块名'] == land, crop].isna().any():
...
result_file_get('./data/附件3/result2.xlsx', './results/final/2024-result3.xlsx',
                './results/3-2024', 2024)
result_file_get('./data/附件3/result2.xlsx', './results/final/2025-result3.xlsx',
                './results/3-2025', 2025)
result_file_get('./data/附件3/result2.xlsx', './results/final/2026-result3.xlsx',
                './results/3-2026', 2026)
result_file_get('./data/附件3/result2.xlsx', './results/final/2027-result3.xlsx',
                './results/3-2027', 2027)
result_file_get('./data/附件3/result2.xlsx', './results/final/2028-result3.xlsx',
                './results/3-2028', 2028)
result_file_get('./data/附件3/result2.xlsx', './results/final/2029-result3.xlsx',
                './results/3-2029', 2029)
result_file_get('./data/附件3/result2.xlsx', './results/final/2030-result3.xlsx',
                './results/3-2030', 2030)