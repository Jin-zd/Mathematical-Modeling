...
one_year_crop_profit_pie('2024作物利润比例分布（前10种）', './pictures/2024作物利润比例分布.png', 2024)
one_year_crop_profit_pie('2025作物利润比例分布（前10种）', './pictures/2025作物利润比例分布.png', 2025)
one_year_crop_profit_pie('2026作物利润比例分布（前10种）', './pictures/2026作物利润比例分布.png', 2026)
one_year_crop_profit_pie('2027作物利润比例分布（前10种）', './pictures/2027作物利润比例分布.png', 2027)
one_year_crop_profit_pie('2028作物利润比例分布（前10种）', './pictures/2028作物利润比例分布.png', 2028)
one_year_crop_profit_pie('2029作物利润比例分布（前10种）', './pictures/2029作物利润比例分布.png', 2029)
one_year_crop_profit_pie('2030作物利润比例分布（前10种）', './pictures/2030作物利润比例分布.png', 2030)
